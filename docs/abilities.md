...
* **Clinch:** grab within 180 units for up to 1.5 seconds. Recast Q to throw 300 units in the aimed direction, using collision sweeps. Held enemies cannot move or attack; common enemies are eligible, elites require an explicit Break-vulnerable state. Release starts a 4-second cooldown. Grabbing/throwing builds Momentum. Downing either participant clears the hold.
