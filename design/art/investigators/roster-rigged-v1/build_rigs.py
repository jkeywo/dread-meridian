...
cfg={
 'sapper':dict(hip=.99,knee=.63,leg=.135,shoulder=1.449,sx=.248,elbow=.525,wrist=.785,head=1.70,neck=1.56,size=1,palm=.842),
 'photographer':dict(hip=1.025,knee=.62,leg=.113,shoulder=1.365,sx=.20,elbow=.467,wrist=.693,head=1.60,neck=1.479,size=.86,palm=.7317),
 'medium':dict(hip=1.025,knee=.62,leg=.113,shoulder=1.365,sx=.20,elbow=.467,wrist=.693,head=1.60,neck=1.479,size=.86,palm=.7317),
 'smuggler':dict(hip=1.13,knee=.65,leg=.164,shoulder=1.56,sx=.285,elbow=.567,wrist=.867,head=1.80,neck=1.69,size=1.38,palm=.9291),
}[asset]
